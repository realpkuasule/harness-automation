...
const cases = [
  ...
  ["local-assets", "src/worktree/qualification.ts", ["assets.entries.length", "readdirSync(resource.path).some((name) => name !== \".git\")"], ["false", "false"], "src/coordination/github.test.ts", "creates approved synthetic worktrees without touching primary content or erasing failure (complete)", "AssertionError: expected [Function] to throw an error"],
