...
const PRESETS: RulePreset[] = [
  {
    ...
    decisions: [
      ...
      { ruleId: "R002", recommendedMedium: "linter" },
      { ruleId: "R003", recommendedMedium: "claude.md" },
      { ruleId: "R004", recommendedMedium: "hook" },
      { ruleId: "R005", recommendedMedium: "linter" },
      { ruleId: "R006", recommendedMedium: "linter" },
      { ruleId: "R007", recommendedMedium: "ci" },
      { ruleId: "R008", recommendedMedium: "hook" },
      { ruleId: "R009", recommendedMedium: "claude.md" },
      { ruleId: "R010", recommendedMedium: "ci" },
      { ruleId: "R011", recommendedMedium: "linter" },
      { ruleId: "R012", recommendedMedium: "linter" },
      { ruleId: "R013", recommendedMedium: "claude.md" },
      { ruleId: "R014", recommendedMedium: "linter" },
      { ruleId: "R015", recommendedMedium: "claude.md" },
      { ruleId: "R016", recommendedMedium: "linter" },
    ],
  },
  {
    id: "library-ts",
