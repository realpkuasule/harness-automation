...
const PRESETS: RulePreset[] = [
  ...
  {
    id: "team-gitlab-ts",
    name: "TypeScript Team (GitLab)",
    description: "TypeScript 团队项目完整 Harness 配置，使用 GitLab CI/CD、MR 模板、安全扫描和团队协作规范",
    techStack: ["typescript", "javascript"],
    decisions: [
      { ruleId: "R001", recommendedMedium: "linter_warn" },
      { ruleId: "R002", recommendedMedium: "linter_warn" },
      ...
      { ruleId: "R010", recommendedMedium: "ci" },
      { ruleId: "R011", recommendedMedium: "linter_warn" },
      { ruleId: "R012", recommendedMedium: "claude_md" },
      { ruleId: "R013", recommendedMedium: "claude_md" },
      { ruleId: "R014", recommendedMedium: "linter_warn" },
      { ruleId: "R015", recommendedMedium: "claude_md" },
      { ruleId: "R016", recommendedMedium: "linter_error" },
      { ruleId: "R017", recommendedMedium: "claude_md" },
      { ruleId: "R018", recommendedMedium: "claude_md" },
      { ruleId: "R019", recommendedMedium: "hook" },
      { ruleId: "R020", recommendedMedium: "claude_md" },
      { ruleId: "R021", recommendedMedium: "ci" },
      { ruleId: "R022", recommendedMedium: "hook" },
      { ruleId: "R023", recommendedMedium: "settings" },
    ],
  },
];
